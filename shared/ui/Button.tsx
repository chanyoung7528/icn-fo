...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap  rounded-btn-lg  text-sm font-medium transition-all disabled:pointer-events-none [&_svg]:pointer-events-none',
  {
    variants: {
      ...
      size: {
        default: 'h-[44px] rounded-md px-4 py-2 has-[>svg]:px-3',
        xsm: 'h-[28px] rounded-xsm px-3 has-[>svg]:px-2.5',
        sm: 'h-[40px] rounded-sm gap-1.5 px-3 has-[>svg]:px-2.5',
        lg: 'h-[48px] rounded-lg px-6 has-[>svg]:px-4',
        xl: 'h-[52px] rounded-xl px-8 has-[>svg]:px-6',
        icon: 'size-9',
      },
    },
    compoundVariants: [
